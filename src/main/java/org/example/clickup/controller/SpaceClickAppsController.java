...
public class SpaceClickAppsController {
    ...
    @GetMapping
    public List<SpaceClickApps> getSpaceClickAppsBySpaceId(@PathVariable Integer id) {
        return (List<SpaceClickApps>) spaceClickAppsService.getAllClickAppsBySpaceId(id);
    }
    @PostMapping
